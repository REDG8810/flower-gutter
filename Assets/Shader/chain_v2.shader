Shader "Custom/chain_v2"
{
    Properties
    {
        ...
        _Color0("Gradient Color 0", Color) = (1,0,0,1) // 赤
        ...
        SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                {
                    color = lerp(_Color0, _Color1, gradientFactor * 100);
                }
                else if (gradientFactor < 0.1)
                {
                    color = lerp(_Color1, _Color2, gradientFactor * 10);
                }
                else
                {
                    color = lerp(_Color2, _Color3, (gradientFactor - 0.2) * 1.25);
                }
